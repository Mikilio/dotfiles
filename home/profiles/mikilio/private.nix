{
  ...
  config = lib.mkMerge [
    {
      sops.gnupg.home = "${config.xdg.dataHome}/gnupg";
    ...
    #NOTE: hyprland
    (lib.mkIf config.programs.hyprpanel.enable {
      i18n.inputMethod.fcitx5.imList = ["keyboard-us" "keyboard-ua" "mozc"];
      programs.hyprpanel.settings.menus.dashboard.powermenu.avatar.image = ./assets/mikilio.png;
    ...
    (lib.mkIf config.programs.thunderbird.enable {
      accounts.email.accounts = {
        Mikilio = {
          address = "kilian.mio@mikilio.com";
          userName = "admin@mikilio.com";
          aliases = ["contact@mikilio.com"];
          realName = "Kilian Mio";
          imap = {
            host = "mail.mikilio.com";
            port = 993;
          };
          smtp = {
            host = "mail.mikilio.com";
    ...
    (lib.mkIf config.programs.rbw.enable {
      programs.rbw.settings.email = "kilian.mio@mikilio.com";
    })
      ...
      programs = {
        git = {
          ...
          settings = {
            user = {
              name = "Mikilio";
              email = "official.mikilio@gmail.com";
            };
            sendemail = {
